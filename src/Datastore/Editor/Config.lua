...
return {
    Fusion = require(game.ReplicatedStorage:WaitForChild("AdminCube"):WaitForChild("Fusion"));
    Spacing = 20;
    Errors = {
        [0] = "";
        [400] = "There has been an error while getting the DataStore. Invalid Key";
        [401] = "There has been an error while getting the DataStore. Is there access to Api Services?"
    };
    IndexColors = {
